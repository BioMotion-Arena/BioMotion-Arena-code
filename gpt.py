...
client = OpenAI(
    ...
    api_key="xxxxxxx"  # enter your api_key
)
...
base64_image1 = encode_image('./example.png')
...
for i in range(3):
  ...
  for action in tqdm(action_list): 
    for point in points:
      # prompt_image = "Example image: <image> \n"
      ...
      response = client.chat.completions.create(
            model=model_name,   # "gpt-4o, gemini-2.0-flash, gemini-1.5-pro"
            messages=[
